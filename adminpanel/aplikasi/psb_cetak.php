...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<tr><td class="isiankanan" width="250px">Berdasarkan Status diterima</td><td class="isian"><input type="button" class="batal" value="Cetak xls &raquo;" onclick="window.location.href='konten/laporan-psb2.php';"></td></tr>
		...
		<tr><td class="isiankanan" width="250px">Semua data PSB</td><td class="isian"><a href="konten/export/pdf.php" target="blank" type="button">CETAK PDF</a></td></tr>
