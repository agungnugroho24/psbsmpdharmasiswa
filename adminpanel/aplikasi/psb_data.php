...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="atastabel" style="margin: 30px 10px 0 10px">
			...
			$pendaftarlaki=mysql_query("SELECT * FROM sh_psb WHERE jk='L'");
			$jmllaki=mysql_num_rows($pendaftarlaki);
			
			$pendaftarperempuan=mysql_query("SELECt * FROM sh_psb WHERE jk='P'");
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$psb=mysql_query("SELECT * FROM sh_psb ORDER BY nisn DESC");
